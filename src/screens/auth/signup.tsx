...
const Signup: React.FC<PropType> = (props) => {
    ...
    const validate = () => {
        ...
        if (isEmpty(password)) set(errors, 'confirmPassword', ['confirm password is required']);
        if (password !== confirmPassword) set(errors, 'confirmPassword', ['both password should be same']);
